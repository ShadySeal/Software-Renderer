...
Scene::Scene()
{
    ...
    Sphere redSphere(Vector3(0, -1, 3), 1, SDL_Color(255, 0, 0, 255));
    Sphere blueSphere(Vector3(2, 0, 4), 1, SDL_Color(0, 0, 255, 255));
    Sphere greenSphere(Vector3(-2, 0, 4), 1, SDL_Color(0, 255, 0, 255));
    Sphere yellowSphere(Vector3(0, -5001, 0), 5000, SDL_Color(255, 255, 0, 255));
